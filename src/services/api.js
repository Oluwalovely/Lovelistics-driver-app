...
export const uploadDriverAvatar = (formData) => API.patch('/update-profile', formData, { headers: { 'Content-Type': 'multipart/form-data' } });
export const changeDriverPassword = (data) => API.post('/change-password', data);
